...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 02, 2018 at 04:16 PM
...
INSERT INTO `clients` (`cust_id`, `client_name`, `client_phone`, `client_email`, `client_country`, `client_state`, `client_city`, `client_postal_address`, `client_notes`, `client_type`, `is_company`, `contact_person_name`, `contact_person_email`, `contact_person_phone`, `contact_person_designation`, `client_since`, `added_on`, `added_by`, `cust_currency`, `is_customer`, `mc_id`, `marketing_campaign_id`, `tariff_block`) VALUES
(2193, 'Vector Aviation', '0704051656', 'info@vector.co.ke', 'Kenya', 'Nrb', 'Nrb', NULL, '', 1, 1, 'Ayub Wambulwa', 'ayubwambulwa@vector.co.ke', '0704051656', 'Director', '2017-01-02', '2017-07-06 11:28:36', 1258, 'KES', 1, 222, NULL, ''),
(2194, 'Avmax Aviation', '0735046542', 'info@avmax.com', 'Kenya', 'Nrb', 'Nrb', NULL, '<p>Does shipping to Japan weekly. Also, takes their plane engines monthly for repair and servicing. But, has an existing freight service provider whom I find to be offering inferior services</p>', 1, 1, 'Smith', 'smith@avmax.com', '0735046543', 'Director', '2015-01-01', '2017-07-06 15:48:41', 1258, 'KES', 1, 222, NULL, ''),
(2195, 'Air Kenya', '0706336225', 'info@airkenya.com', 'Kenya', 'Nrb', 'Nrb', NULL, '', 1, 1, 'Philip Kamaru', 'philip@airkenya.com', '0784587855', 'Manager', '2016-02-02', '2017-07-06 16:52:06', 1258, 'KES', 1, 222, NULL, ''),
(2196, 'omenda joseph', '0797654321', 'kissmy@gmaiI.com', 'Kenya', 'NAIROBI', 'Nairobi', NULL, '<p><b><u>First&nbsp;proposal</u></b></p><p>mkora</p><p><b><br></b></p>', 2, 1, 'Shakira', 'wakawaka@eheh', '07911911911', 'Director', '2017-01-09', '2017-07-17 11:02:49', 1259, 'USD', 0, 216, NULL, ''),
(2197, 'Hello World', '48759654213', 'hello@abc.com', 'Kenya', 'Nairobi', 'Nairobi', NULL, '', 2, 0, 'Joseph Omena', 'jos@abc.com', '9985746566', 'Manager', '2017-09-01', '2017-09-01 16:39:00', 1259, 'KES', 1, 214, NULL, ''),
(2201, 'Wambulwa', '0704051657', 'ayub@willfreight.co.ke', 'Kenya', 'Nairobi', 'Nairobi', NULL, '<p>Test&nbsp;&nbsp;&nbsp;&nbsp;</p>', 1, 1, 'Ayub', 'ayub@pursuit.com', '0707038879', 'Manager', '0000-00-00', '2017-10-02 15:32:13', 1259, 'USD', 1, 216, NULL, ''),
(2205, 'Bluebird Aviation', '0756421254', 'info@bluebird.com', 'Kenya', 'Nairobi', 'Nairobi', '3758 - 00200 Nairobi', '', 1, 1, 'Ahmed Ali', 'md@bluebird.com', '0704512545', 'Director', '2017-11-27', '2017-11-27 07:38:12', 1259, 'KES', 1, 219, NULL, 'A'),
(2206, 'Albert Freighters', '0728987590', 'alberteshiwani@willfreight.co.ke', 'Kenya', 'Nakuru', 'Nakuru', '3758 - 20100 Nakuru', '', 1, 1, 'Albert Eshiwani', 'alberteshiwani@willfreight.co.ke', '0728987590', 'Director', '2018-01-03', '2018-01-03 17:41:44', 1258, 'USD', 1, 222, NULL, NULL),
(2207, 'Sigrut International', '888557469', 'sales@sigrut.com', 'Kenya', 'Kisumu', 'Kisumu', '5246 - 54200 Kisumu', '<p>The client transports fresh farm produce regularly</p>', 1, 1, 'Bryan Wanyande', 'bryanwanyande@sigrut.com', '0735511055', 'Director', '2017-02-01', '2018-02-01 16:41:35', 1258, 'KES', 1, 214, 7, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `client_session_notes`
--

DROP TABLE IF EXISTS `client_session_notes`;
CREATE TABLE IF NOT EXISTS `client_session_notes` (
  `csn_id` int(11) NOT NULL AUTO_INCREMENT,
  `session_date` date NOT NULL,
  `session_type` varchar(100) NOT NULL,
  `session_person` varchar(200) NOT NULL,
  `session_topic` varchar(200) NOT NULL,
  `session_notes` text NOT NULL,
  `csn_client_id` int(11) NOT NULL,
  `csn_added_by` int(11) NOT NULL,
  `csn_added_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`csn_id`),
  KEY `csn_client_id_fk` (`csn_client_id`),
  KEY `cust_sess_notes_added_by_fk` (`csn_added_by`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `client_session_notes`
--

INSERT INTO `client_session_notes` (`csn_id`, `session_date`, `session_type`, `session_person`, `session_topic`, `session_notes`, `csn_client_id`, `csn_added_by`, `csn_added_at`) VALUES
(7, '2018-01-01', 'Client Visit', 'Test Person', 'Just testing ooh', 'Delete this text to enter the summary of your conversation with Vector Aviation', 2193, 1258, '2018-02-02 17:19:33'),
(8, '2018-02-02', 'Phone call', 'Kahl Simon -MD', 'Revision of rates', '<p>Client was complaining of high rates we charge over our competitors and requested that we revise our charges.</p><p>We revised the charges with Willfreight MD</p>', 2193, 1258, '2018-02-02 18:14:48');
...
INSERT INTO `marketing_campaigns` (`campaign_id`, `campaign_name`, `campaign_beneficiary`, `mc_id`, `campaign_budget`, `campaign_start_date`, `campaign_end_date`, `campaign_notes`, `campaign_added_on`, `campaign_added_by`, `campaign_started`, `campaign_stopped`) VALUES
(7, 'Test1', 'WEC', 214, 25000, '2018-01-18', '2018-02-18', 'Testing 001', '2018-01-11 12:20:50', 1258, 1, 0),
(8, 'Generate online leads (1 Quarter 2017)', 'WEC', 215, 80000, '2018-02-28', '2018-03-28', 'Coordinate with ICT department and run the campaign together. They will help in getting competitive keywords for the campaign', '2018-01-11 15:15:36', 1258, 0, 0),
(9, 'Q1 2018 new customer acquisition', 'WEC', 217, 100000, '2018-03-01', '2018-03-01', '<p>The event will be held at KICC from 8-5pm daily.</p><p>Will have to prepare banners, screen projections, catalogues, etc.</p><p>Will collect potential client details(Name, Phone, Email, Company, Country, Industry, etc.) in our data capture forms.</p>', '2018-01-22 16:31:45', 1258, 0, 0),
(10, 'Exhibition', 'WEC', 217, 250000, '2018-03-15', '2018-03-15', 'Prepare banners, brochures, slide presentations', '2018-01-26 16:27:50', 1258, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `marketing_campaign_goals`
--

DROP TABLE IF EXISTS `marketing_campaign_goals`;
CREATE TABLE IF NOT EXISTS `marketing_campaign_goals` (
  `mcg_id` int(11) NOT NULL AUTO_INCREMENT,
  `mcg_name` text NOT NULL,
  `mcg_achieved` varchar(10) NOT NULL DEFAULT 'NO',
  `mcg_why_not_achieved` text,
  `marketing_campaign_id` int(11) NOT NULL,
  PRIMARY KEY (`mcg_id`),
  KEY `mcid_fk` (`marketing_campaign_id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `marketing_campaign_goals`
--

INSERT INTO `marketing_campaign_goals` (`mcg_id`, `mcg_name`, `mcg_achieved`, `mcg_why_not_achieved`, `marketing_campaign_id`) VALUES
(9, 'Test1', 'NO', NULL, 7),
(10, 'Test2', 'NO', NULL, 7),
(11, 'Test3', 'NO', NULL, 7),
(12, 'Generate leads and prospects from online campaigns', 'NO', NULL, 8),
(13, 'Grow sales volume by 10%', 'YES', NULL, 8),
(14, 'Get new regular cl;ients', 'YES', NULL, 8),
(15, 'Gain potential clients', 'YES', NULL, 9),
(16, 'Create awareness of our services', 'NO', NULL, 9),
(17, 'Grow sales by 10%', 'YES', NULL, 10),
(18, 'To get 5 new regular clients', 'YES', NULL, 10);

-- --------------------------------------------------------

--
-- Table structure for table `marketing_campaign_notes`
--

DROP TABLE IF EXISTS `marketing_campaign_notes`;
CREATE TABLE IF NOT EXISTS `marketing_campaign_notes` (
  `mcn_id` int(11) NOT NULL AUTO_INCREMENT,
  `mcn_campaign_id` int(11) NOT NULL,
  `mcn_notes` text NOT NULL,
  `mcn_added_on` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `mcn_added_by` int(11) NOT NULL,
  `mcn_type` varchar(100) NOT NULL,
  PRIMARY KEY (`mcn_id`),
  KEY `mcn_campaign_id_fk` (`mcn_campaign_id`),
  KEY `mcn_added_by` (`mcn_added_by`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `marketing_campaign_notes`
--

INSERT INTO `marketing_campaign_notes` (`mcn_id`, `mcn_campaign_id`, `mcn_notes`, `mcn_added_on`, `mcn_added_by`, `mcn_type`) VALUES
(1, 10, '<ul><li>Created Flyers and handouts. They\'re all printed and ready</li><li>Also created Projections screens</li></ul>', '2018-01-29 10:32:30', 1258, 'Daily notes'),
(2, 9, '<p>Test&nbsp;&nbsp;&nbsp;&nbsp;</p>', '2018-01-29 10:43:46', 1258, 'Daily notes'),
(3, 7, '<p>Test daily note</p>', '2018-02-01 10:35:23', 1258, 'Daily notes'),
(4, 7, '<p>Test summary</p>', '2018-02-01 10:35:36', 1258, 'Campaign summary');
...
--
-- Constraints for table `client_session_notes`
--
ALTER TABLE `client_session_notes`
  ADD CONSTRAINT `csn_client_id_fk` FOREIGN KEY (`csn_client_id`) REFERENCES `clients` (`cust_id`),
  ADD CONSTRAINT `cust_sess_notes_added_by_fk` FOREIGN KEY (`csn_added_by`) REFERENCES `employee` (`staff_wec_emp_no`);
...
ALTER TABLE `marketing_campaigns`
  ADD CONSTRAINT `mc_mc_id_fk` FOREIGN KEY (`mc_id`) REFERENCES `marketing_channels` (`ch_id`);

--
-- Constraints for table `marketing_campaign_goals`
--
ALTER TABLE `marketing_campaign_goals`
  ADD CONSTRAINT `mcid_fk` FOREIGN KEY (`marketing_campaign_id`) REFERENCES `marketing_campaigns` (`campaign_id`);

--
-- Constraints for table `marketing_campaign_notes`
--
ALTER TABLE `marketing_campaign_notes`
  ADD CONSTRAINT `mcn_added_by` FOREIGN KEY (`mcn_added_by`) REFERENCES `employee` (`staff_wec_emp_no`),
  ADD CONSTRAINT `mcn_campaign_id_fk` FOREIGN KEY (`mcn_campaign_id`) REFERENCES `marketing_campaigns` (`campaign_id`);
