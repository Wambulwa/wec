      ...
      <div class="main-content">
        ...
        <form id="wizardForm" class="form-horizontal" role="form" method="post" action="<?php echo base_url('sales/addClient'); ?>">
          <div class="card">
...
<!--contact-->
                  <div class="tab-pane p-x-lg" id="tab1">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-10">
                        <span class="input input--focused m-b-md">
                          <select class="input__field cust-col" name="mcampaign_id" required="" style="width: 100%;">
                          <option selected="" disabled="">Marketing campaign</option>
                          <?php foreach ($marketingCampaigns as $marketingCampaigns):?>
                          <option value="<?php echo $marketingCampaigns->campaign_id;?>" title="<?php echo 'Run from '.$marketingCampaigns->campaign_start_date.' -> '.$marketingCampaigns->campaign_end_date.' via '.$marketingCampaigns->staff_fname;?>"><?php echo $marketingCampaigns->campaign_name;?></option>
                        <?php endforeach;?>
                        </select>
                          <label class="input__label" for="input-2">
                            <span class="input__label-content">Marketing campaign (if is from a campaign)</span>
                          </label>
                        </span>
                      </div>
                    </div>
