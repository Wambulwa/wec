                    ...
                    <div class="form-group row">
                      <div class="col-sm-10">
                        <span class="input input--focused m-b-md">
                          ...
                          <option value="<?php echo $marketingCampaigns->campaign_id;?>" title="<?php echo 'Run from '.$marketingCampaigns->campaign_start_date.' -> '.$marketingCampaigns->campaign_end_date.' via '.$marketingCampaigns->ch_name;?>"><?php echo $marketingCampaigns->campaign_name;?></option>
                        <?php endforeach;?>
                        </select>
                          <label class="input__label" for="input-2">
