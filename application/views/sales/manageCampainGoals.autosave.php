        ...
        <div class="card bg-white" style="background: #fff;">
          ...
          <div class="card-block">
            ...
            <div class="form-group" style="background: #fff;">
              <div class="col-sm-12">
                <div class="control-label" style="font-size: 19px;font-weight: bold;"><hr><i class="fab fa-accusoft"></i>Daily campaign notes & activities<button class="btn btn-sm btn-block" data-toggle="modal" data-target="#dailyNotes">view daily notes</button><hr></div>
              </div>
            </div>
