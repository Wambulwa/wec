                          ...
                          <tr>
                              <td colspan="2">
                                <div class="col-sm-10"></div>
                                  <input type="button" class="btn btn-block " id="addrow" value="Add New Charge">
                              </td>
                          </tr>
                          <tr>
...
<!--/LOAD CONSIGNMENTS-->
    ...
    $("#addrow").on("click", function () {
        ...
        cols += '<td><input type="button" class="ibtnDel btn btn-md btn-danger btn-sm" value="Delete" onclick="calculateGrandTotal()"></td>';
        newRow.append(cols);
