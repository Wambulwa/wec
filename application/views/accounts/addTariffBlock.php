        ...
        <div class="card">
          ...
          <?php echo form_open('accounts/addTariffBlock');?>
            ...
            <div class="form-group">
              <div class="col-sm-10">
                <span class="input input--focused m-b-md">
                  <textarea class="input__field cust-col" type="text" name="ctb_description" placeholder="Describe the block here e.g. Which type of clients it applies to, etc." required="" style="height: 27%; background-color: #ffffff;"></textarea>
                  <label class="input__label" for="input-2">
