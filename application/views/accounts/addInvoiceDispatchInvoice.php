      ...
      <div class="main-content" style="margin-top: -15px;">
        <div class="page-title" style="">
          ...
          <div class="pull-right">
            <?php echo form_open('accounts/invoiceDispatchSuccess');?><input type="text" name="invoice_id" value="<?php echo $invoice_id;?>" hidden=""><button class="btn btn-info no-print btn-sm">SEND TO CS FOR DISPATCH</button><?php echo form_close();?>
          </div>
