          ...
          <div class="card-block">
            <table class="table table-bordered table-condensed datatable m-b-0">
              ...
              <?php if(isset($clients)){ foreach ($clients as $clients) {?>
                <tr>
                  <td>
                    <?php echo form_open('accounts/manageClient');?>
                    ...
                    <button style="background: white; border-style: none;"><?php  echo $clients->cust_id;?>
                  </td>
                  <td>
                    <?php  echo $clients->client_name;?>
                  </td>
                  <td><?php  echo "Tel: $clients->client_phone";?><br><?php  echo "Email:  $clients->client_email";?><?php  //echo "$clients->client_postal_address";?><br><?php  echo "Location: $clients->client_city, $clients->client_country";?>
                  </td>
