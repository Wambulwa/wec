      ...
      <div class="main-content" style="margin-top: -15px;">
        <div class="page-title" style="">
          ...
          <div class="pull-right">
            <?php echo form_open('accounts/invoicePayment');?><input type="text" name="inv_id" value="<?php echo $invoice_id;?>" hidden=""><button class="btn btn-info no-print btn-sm">PAYMENT</button><?php echo form_close();?>
          </div>
