          ...
          <div class="card-block">
            <table class="table table-bordered table-condensed datatable m-b-0">
              ...
              <?php if(isset($prospects)){ foreach ($prospects as $clients) {?>
                <tr>
                  <td><?php echo form_open('cs/manageProspects');?><input type="text" name="client_id" value="<?php  echo $clients->cust_id;?>" hidden=""><button style="background: white; border-style: none;"><?php  echo $clients->cust_id;?></button><?php echo form_close();?></td>
