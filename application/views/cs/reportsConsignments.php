      ...
      <div class="main-content">
        ...
        <div class="form-group row">
          <?php echo form_open('cs/reportsConsignments');?>
            ...
            <div class="card bg-white">
              ...
              <div class="card-block">
                <table class="display nowrap" id="exportFreight" width="100%" cellspacing="0" border="1">
                  ...
                  <tbody>
                    <?php $sumCharge=0; foreach ($freight as $freight): $sumCharge+=$freight->sum_freight; ?>
                    <tr>
                  ...
                  <tfoot><td><strong>Total charges</strong></td><td></td><td></td><td></td><td><strong><?php echo $sumCharge;?></strong></td></tfoot>
                </table>
              </div>
            </div>
            <!-- //EXPENSES LIST -->
            ...
            <div class="card bg-white">
              ...
              <div class="card-block">
                <table class="display nowrap" id="exportClearance" width="100%" cellspacing="0" border="1">
                  ...
                  <tbody>
                    <?php $sumClear=0; foreach ($clearance as $clearance): $sumClear+=$clearance->clearance;?>
                    <tr>
                  ...
                  <tfoot><td><strong>Total</strong></td><td></td><td></td><td></td><td><strong><?php echo $sumClear;?></strong></td></tfoot>
                </table>
              </div>
            </div>
            <!-- //EXPENSES LIST -->
