      ...
      <div class="main-content">
        <div class="page-title">
          <div class="title">Add new prospect</div>
          <div class="sub-title">
        ...
        <form id="wizardForm" class="form-horizontal" role="form" method="post" action="<?php echo base_url('sales/addProspect'); ?>">
          <div class="card">
...
<!--contact-->
                  <div class="tab-pane p-x-lg" id="tab1">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        <select class="form-control cust-col" name="mc" required="" data-toggle="tool-tip" title="Marketing channel used to acquire client">
                          <option selected="" disabled=""><--Marketing Channel--></option>
...
<div id="newCompany" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content col-sm-12">
      ...
      <form role="form" method="post" action="<?php echo base_url('sales/addProspect');?>" >
        <div class="form-group">
