      ...
      <div class="main-content">
        <div class="page-title">
          <div class="title">Add new lead</div>
          <div class="sub-title">
        ...
        <form id="wizardForm" class="form-horizontal" role="form" method="post" action="<?php echo base_url('sales/addLead'); ?>">
          <div class="card">
...
<div id="newCompany" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content col-sm-12">
      ...
      <form role="form" method="post" action="<?php echo base_url('sales/addLead');?>" >
        <div class="form-group">
