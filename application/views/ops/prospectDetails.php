      <div class="main-content">
        <div class="page-title">
          ...
          <ol class="breadcrumb no-bg pl0">
            ...
            <li>
              <a href="<?php echo base_url('sales/manageProspects');?>">Prospects</a>
            </li>
            <li class="active">Manage Prospect</li>
          </ol>
        </div>
        <!-- <p>Vertical Tabs</p>
        <div class="row">
                  ...
                  <table style="width: 100%;" class="table table-bordered" border="1">
                    ...
                    <?php foreach ($client as $client):?>
                      <tr>
                        ...
                        <td><?php echo form_open('sales/convertTo');?><input type="text" name="propect_id" value="<?php echo $client->cust_id;?>" hidden=""><button class="btn btn-primary">CONVERT TO CLIENT</button><?php echo form_close();?></td>
                      </tr>
                    <?php endforeach;?>
                    </tbody>
                  </table>
