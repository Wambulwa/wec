              ...
              <div class="tab-content">
                <div class="tab-pane active in" id="profile">
                  ...
                  <table style="width: 100%;" class="table table-bordered" border="1">
                    <thead style="font-weight: bold; background: #4b78c1; color: #fff;">
                      <th>ABOUT</th>
                      <th>Contact</th>
                ...
                <div class="tab-pane" id="shipments">
                  <h3>Client business value to date</h3>
                  <table style="width: 100%; border-style: dashed;" border="1"><thead><th></th></thead></table><br>
                  <table style="width: 100%; border-style: dashed;" border="1" class="table table-bordered">
                    <thead style="background: #4b78c1; color: #fff;">
                      <th>Date</th><th>File#</th><th>Shipment description</th><th></th>
                    </thead>
                    <tbody>
                      ...
                      <tr>
                        <td>
                          ...
                          <?php echo form_hidden('cons_id',$shipments->cons_id,'class="form-control"');?>
                          <?php echo $shipments->cons_date_opened;?>
                        </td>
                        <td><?php echo $shipments->cons_id;?></td>
                        <td><?php echo $shipments->cons_desc;?></td>
                        <td>
                          <?php echo form_submit('open_cons','Open','class="btn btn-sm btn-primary"');?>
                          <?php echo form_close();?>
                        </td>
                      </tr>
                      <?php endforeach;?>
